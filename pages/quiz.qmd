...
1. A convolutional layer has 64 input activations ($C_{in} = 64$ and $H=16$, $W=16$). You want to reduce its spatial dimensionality by half, while increasing the number of channels. How do you parameterize your convolutional layer?
