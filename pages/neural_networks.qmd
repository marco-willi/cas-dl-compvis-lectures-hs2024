...
The following parameters must be learned from data using an optimization method: $\mathbf{W}$ and $\mathbf{b}$. See @sec-links-nn for links on _backpropagation_ and _gradient descent_.
