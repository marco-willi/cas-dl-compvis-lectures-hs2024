...
![True distribution (left) and predicted distribution (right).]({{< meta params.images_path >}}cross_entropy.png){width=100% height=70%}
...
![AlexNet @llamas_classification_2017]({{< meta params.images_path >}}alexnet2.png){width=100% height=70%}

## AlexNet: Table

![Source: @johnson_eecs_2019]({{< meta params.images_path >}}alexnet_table.jpg){width=100% height=70%}

## VGG

![VGG @simonyan_very_2015]({{< meta params.images_path >}}vgg.png){width=100% height=70%}
...
![Source: @He2016]({{< meta params.images_path >}}resnet_test_error.jpg){width=100% height=70%}

## ResNet

![Source: @He2016]({{< meta params.images_path >}}resnet_train_error.jpg){width=100% height=70%}
...
![ConvNext @liu_convnet_2022]({{< meta params.images_path >}}convnext.png){width=100% height=70%}

## ImageNet Performance

![Image from @johnson_eecs_2019]({{< meta params.images_path >}}image_net_performance.jpg){width=100% height=70%}
