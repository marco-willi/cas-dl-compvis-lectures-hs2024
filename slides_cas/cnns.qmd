...
![Schmatic illustration of connected neurons. Source: @phillips_speed_2015]({{< meta params.images_path >}}connected_neurons.png)
...
What is the output dimensionality of convolving a 3x3 kernel?
:::

::: {.column width="50%"}
![ ]({{< meta params.images_path >}}padding_input_activations_5x5_with_zero_padding.jpg)
What is the output dimensionality with zero-padding?
:::
...
Spatial  downsampling is often a desired property of convolutional layers. We can achieve that by choosing a stride $\gt 1$.
...
![Source: @prince_understanding_2023e]({{< meta params.images_path >}}1x1_conv_example.jpg)
...
![Global Average pooling, input (left) and output (right).]({{< meta params.images_path >}}global_average_pooling.png)
:::
